package com.liuweijw.api.security.token;
...
import com.liuweijw.api.security.Scopes;
...
public class JwtTokenFactory {
	...
	public AccessJwtToken createAccessJwtToken(UserContext userContext) {
		...
		if (userContext.getAuthorities() == null
				|| userContext.getAuthorities().isEmpty())
			throw new IllegalArgumentException(
		...
		String token = Jwts
				...
				.setIssuedAt(
						Date.from(currentTime.atZone(ZoneId.systemDefault())
								.toInstant()))
				.setExpiration(
				...
				.signWith(SignatureAlgorithm.HS512,
						settings.getTokenSigningKey()).compact();
